...
if __name__ == "__main__":
    ...
    # Position lists
    q[2]=q[2]+[(0.3048, 0.0)] + [[]] + [float('inf')]
    q[0]=q[0]+[(0.3048, 0.1016)] + [[]]  + [float('inf')]
    q[7]=q[7]+[(0.1524, 0.0)] + [[]]  + [float('inf')]
    q[3]=q[3]+[(0.0,0.0)] + [[]]  + [float('inf')]
    q[1]=q[1]+[(0.0, 0.1016)] + [[]]  + [float('inf')]
    q[4]=q[4]+[(0.0, 0.2032)] + [[]] + [float('inf')]
    q[10]=q[10]+[(0.1524, 0.1016)] + [[]] + [float('inf')]
    q[6]=q[6]+[(0.1524, 0.2032)] + [[]] + [float('inf')]
    q[8]=q[8]+[(0.3048, 0.2032)] + [[]]  + [float('inf')]
    q[5]=q[5]+[(0.4572,0.1016)] + [[]] + [float('inf')]
    q[9]=q[9]+[(0.4572, 0.2032)] + [[]] + [float('inf')]
...
#    q[10]=q[10]+[(0.4572, 0.2032)] + [[]] + [float('inf')]
    ...
    for count in range(NUM_SENSORS):
        results.append(
        pool.apply_async(read_data_window, args=(ready_to_read,ready_to_source,'128.138.224.254', TCP_PORT+count, q, count)) 
        )
