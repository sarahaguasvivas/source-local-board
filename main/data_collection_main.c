...
void app_main(void)
{
    ...
    init_buffer();
    /* 
    Once the timer is initialized, the ADCs can be read at any time further,    so make sure that the ADCs are set up the way you want, and the buffers     are properly allocated.
    */
    init_timer(500);
